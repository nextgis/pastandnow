...
declare module "@nextgisweb/pyramid/type/api" {
    ...
    export type PyramidCSetting = ("all" | "allow_origin" | "custom_css" | "header_logo" | "full_name" | "home_path" | "metrics");
...
declare module "@nextgisweb/auth/type/api" {
    export {};
    export type Permission = ("auth.view" | "auth.manage" | "spatial_ref_sys.view" | "spatial_ref_sys.manage" | "pyramid.cors.view" | "pyramid.cors.manage");
...
declare module "@nextgisweb/resource/type/api" {
    ...
    export type ResourceInterface = ("IBboxLayer" | "IFeatureLayer" | "IFieldEditableFeatureLayer" | "IGeometryEditableFeatureLayer" | "IWritableFeatureLayer" | "IVersionableFeatureLayer" | "IRenderableStyle" | "ILegendableStyle" | "IRenderableNonCached" | "IRenderableScaleRange" | "ILegendSymbols");
    export type ResourceScope = ("resource" | "data" | "connection" | "service" | "webmap" | "Collector");
    ...
    export type ResourceFavoriteCreate = ResourceShowFavorite | ResourceUpdateFavorite | LayerPreviewMapFavorite | FeatureLayerFeatureBrowseFavorite | WebmapDisplayFavorite | ns426.WebMapFragmentFavorite;
    ...
    export type ResourceCSettingsUpdate = {resource_export?: ResourceExport | null};
}

declare module "@nextgisweb/resmeta/type/api" {
    export {};
    export type ResmetaRead = {items: Record<string, string | number /* int */ | boolean | number /* float */ | null>};
    export type ResmetaUpdate = {items?: Record<string, string | number /* int */ | boolean | number /* float */ | null>};
    export type ResmetaCreate = {items?: Record<string, string | number /* int */ | boolean | number /* float */ | null>};
}
...
declare module "@nextgisweb/feature-layer/type/api" {
    ...
    export type FeatureLayerFieldRead = {
        ...
        keyname: string;
        display_name: string;
        datatype: ("INTEGER") | ("BIGINT") | ("REAL") | ("STRING") | ("DATE") | ("TIME") | ("DATETIME");
        typemod: any;
        label_field: boolean;
    ...
    export type OperationFieldValue = [
        id: number /* int */,
        val: any,
    ];
    export type FeatureCreate = {
...
declare module "@nextgisweb/webmap/type/api" {
    ...
    export type WebMapCSetting = ("all" | "identify_radius" | "identify_attributes" | "show_geometry_info" | "popup_width" | "popup_height" | "address_search_enabled" | "address_search_extent" | "address_geocoder" | "yandex_api_geocoder_key" | "nominatim_countrycodes" | "units_length" | "units_area" | "degree_format" | "measurement_srid" | "legend_symbols" | "hide_nav_menu" | "identify_panel");
    export type AddressGeocoder = ("nominatim" | "yandex");
    export type LengthUnits = ("m" | "km" | "metric" | "ft" | "mi" | "imperial");
    export type AreaUnits = ("sq_m" | "sq_km" | "metric" | "ha" | "ac" | "sq_mi" | "imperial" | "sq_ft");
...
declare module "@nextgisweb/vector-layer/type/api" {
    ...
    export type VectorLayerRead = {
        ...
        geometry_type: ("POINT") | ("LINESTRING") | ("POLYGON") | ("MULTIPOINT") | ("MULTILINESTRING") | ("MULTIPOLYGON") | ("POINTZ") | ("LINESTRINGZ") | ("POLYGONZ") | ("MULTIPOINTZ") | ("MULTILINESTRINGZ") | ("MULTIPOLYGONZ");
    };
...
declare module "@nextgisweb/wfsclient/type/api" {
    ...
    export type LayerObject = {
        name: string;
        srid: number /* int */;
        bbox: [number /* float */, number /* float */, number /* float */, number /* float */];
    };
...
declare module "@nextgisweb/tmsclient/type/api" {
    ...
    export type LayerObject = {
        ...
        minzoom: number /* int */;
        maxzoom: number /* int */;
        bounds: [number /* float */, number /* float */, number /* float */, number /* float */];
    };
    export type InspectResponse = {layers: (LayerObject)[]};
}
...
declare module "@nextgisweb/sld/type/api" {
    ...
    export type Rule = {symbolizers: (PointSymbolizer | LineSymbolizer | PolygonSymbolizer | RasterSymbolizer)[]};
...
declare module "@nextgisweb/tracker/type/api" {
    ...
    export type TrackerCSetting = ("all" | "stop_min_speed" | "stop_min_time" | "time_zone" | "split_time_diff");
...
declare module "@nextgisweb/audit/type/api" {
    ...
    export type AuditArrayLogEntry = [string, (string | number /* int */ | null)[]];
...
declare module "@nextgisweb/pyramid/type/route" {
    ...
    export type Routes = {
        ...
        "pyramid.settings": {
            ...
            pathArr: [];
            get: {
                query: {component: ("pyramid" | "auth" | "resource" | "file_upload" | "spatial_ref_sys" | "feature_layer" | "feature_attachment" | "render" | "webmap" | "raster_layer" | "wmsclient" | "tmsclient" | "basemap" | "cadaster" | "collector" | "demo" | "ngwcluster" | "tracker")};
        ...
        "resource.export": {
            ...
            get: {
                ...
                response: unknown /* <class 'pyramid.response.FileResponse'> */ | unknown /* <class 'pyramid.response.Response'> */;
            };
        };
        ...
        "feature_layer.transaction.item": {
            ...
            "get": {response: ([number /* int */, ns410.FeatureCreateResult | ns410.FeatureUpdateResult | ns410.FeatureDeleteResult | ns410.FeatureRestoreResult])[]};
            "post": {response: ns410.CommitErrors | ns410.CommitSuccess};
            "put": {
                body: ([number /* int */, ns410.FeatureCreate | ns410.FeatureUpdate | ns410.FeatureDelete | ns410.FeatureRestore | null])[];
                response: null;
            };
            "delete": {response: null};
        };
        ...
        "feature_layer.changes_fetch": {
            ...
            get: {
                ...
                response: (ns410.ChangesContinue | ns410.FeatureCreate | ns410.FeatureUpdate | ns410.FeatureDelete | ns410.FeatureRestore | ns1163.DescriptionPut | ns1165.AttachmentCreate | ns1165.AttachmentUpdate | ns1165.AttachmentDelete)[];
            };
        };
        ...
        "render.tile": {
            ...
            get: {
                ...
                response: unknown /* <class 'pyramid.response.Response'> */ | unknown /* <class 'pyramid.response.Response'> */ | unknown /* <class 'pyramid.response.Response'> */;
            };
        };
        "render.image": {
            pathObj: Record<string, never>;
        ...
        "qgis.style_qml": {
            pathObj: {id: number /* int */};
            pathArr: [id: number /* int */];
            get: {query: {original?: ns555.OriginalEnum}} | {query: {original?: ns555.OriginalEnum}};
        };
