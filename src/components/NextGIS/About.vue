<template>
  <v-app>
    <v-layout align-center justify-center column fill-height>
      <div class="title font-weight-thin pa-3">Разработано в</div>

      <div class="logo" @click="openNextGIS">
        <svg
          ...
          style="enable-background: new 0 0 818.8 111.5"
          xml:space="preserve"
        >
          <path
            class="logo__item--dark"
          ...
          <path
            class="logo__item--light"
            d="M674.9,111.5h22.2V0h-22.2V111.5z"
          />
          <path
            class="logo__item--light"
